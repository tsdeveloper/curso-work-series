...
<body>
    ...
    <article class="container">
        <div class="content">
            ...
            <!-- VIDEO -->
            <video class="vga vga-large main_vga animation animation_scale" src="<?= BASE; ?>/midias/apresentacao.mp4"
    ...
    <footer class="container bg-light">
        <section class="main_footer content">
            ...
            <article class="box box-medium">
                ...
                <ul>
                    <li>
                        <a class="shorticon shorticon-facebook" target="_blank" rel="nofollow" href="http://facebook.com"
                            title="Assista o vídeo de apresentação">Facebook</a>
                    </li>
                    <li>
                        <a class="shorticon shorticon-twitter" target="_blank" rel="nofollow" href="http://twitter.com"
                            title="Assista o vídeo de apresentação">Twitter</a>
                    </li>
                    <li>
                        <a class="shorticon shorticon-google-plus" target="_blank" rel="nofollow" href="http://youtube.com.br"
                            title="Assista o vídeo de apresentação">Youtube</a>
                    </li>
